  ...
  return (
    <footer className="bg-slate-800 text-white">
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-wrap justify-center items-center gap-4 md:gap-12 text-center text-sm">
          <span className="text-slate-400 mr-6 md:mr-12">&copy; {new Date().getFullYear()} ◯◯社会保険労務士事務所. All rights reserved.</span>
