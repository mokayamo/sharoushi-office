    ...
    <section id="contact" className="py-24 bg-white min-h-screen flex items-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="bg-secondary p-8 rounded-lg">
            ...
            <p className="text-slate-600 mb-6">まずはお気軽にご連絡ください。「少し話を聞いてみたい」だけでも歓迎です。</p>
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <span className="ml-3 text-2xl font-semibold text-slate-700">03-XXXX-XXXX</span>
              </div>
              <div className="flex items-center">
                <svg className="h-6 w-6 text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                <span className="ml-3 text-lg text-slate-700">info@sharoushi-sample.jp</span>
              </div>
            </div>
